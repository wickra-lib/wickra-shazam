...
`wickra-shazam` is part of the Wickra project and follows the same lightweight
governance model.
...
has been reviewed. Larger or breaking changes (the `FingerprintSpec` / feature schema,
